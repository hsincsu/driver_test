...
{  
	...
	mac_reg_write(rnic_pdata,mac_id,0x3124+channel_base_addr,0x00000001);                 // DMA_CH(#i)_TxDesc_Tail_LPointer:(0x0080*i)+0x3124
    ...
    mac_reg_write(rnic_pdata,mac_id,0x312c+channel_base_addr,0x00000001);                 // DMA_CH(#i)_RxDesc_Tail_LPointer:(0x0080*i)+0x312c	
