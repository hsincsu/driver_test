...
{  
    ...
    mac_reg_write(rnic_pdata,mac_id,0x1100+channel_base_addr,0x003f050a);                 // MTL_TxQ(#i)_Operation_Mode [TQS:7f(16KB) | Q2TCMAP:101(TC5) | TTC��000(64) | TXQEN:10(DCB/Generic) | TSF:1 | FTQ:0]
	...
	u32 regval;
	regval = mac_reg_read(rnic_pdata,mac_id,0x1100+channel_base_addr);                 // MTL_TxQ(#i)_Operation_Mode [TQS:7f(16KB) | Q2TCMAP:101(TC5) | TTC��000(64) | TXQEN:10(DCB/Generic) | TSF:1 | FTQ:0]
...
void mac_eth_channel_cfg (struct rnic_pdata*rnic_pdata,int mac_id,int channel_id)
{
    ...
    mac_reg_write(rnic_pdata,mac_id,0x1100+channel_base_addr,0x00ff000a);                          // MTL_TxQ(#i)_Operation_Mode [TQS:ff(64KB) | Q2TCMAP:000(TC0) | TTC��000(64) | TXQEN:10(DCB/Generic) | TSF:1 | FTQ:0]
    mac_reg_write(rnic_pdata,mac_id,0x1118+channel_base_addr,0x0000000a);                          // MTL_TC(#i)_Quantum_Weight
    mac_reg_write(rnic_pdata,mac_id,0x1140+channel_base_addr,0x00ff00b0);                          // MTL_RxQ(#i)_Operation_Mode[RQS:ff(64KB) | EHFC:1 | RSF:1 | FEF:1]
