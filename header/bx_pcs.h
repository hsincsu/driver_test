...
void    pcs_an_ext_np_on			            (struct rnic_pdata*,int);
void    pcs_an_rst					            (struct rnic_pdata*,int);
void    pcs_an_start							(struct rnic_pdata*,int);
void    pcs_an_pdet_en				            (struct rnic_pdata*,int);
...
//KRT
int     pcs_krt_start				            (struct rnic_pdata*,int,int);
...
void	pcs_tx_eq_test							(struct rnic_pdata*,int);
