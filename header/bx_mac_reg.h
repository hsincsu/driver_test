...
#ifndef __BX_MAC_REG_H__
#define __BX_MAC_REG_H__
...
#define MAC_RQEC                                0x0140 //insomnia: old name is MAC_RQC0R
#define MAC_RQMC                                0x0160 //insomnia: old name is MAC_RQC2R
...
#define MAC_RQMC_INC                            4 //insomnia: old name is MAC_RQC2R_INC
#define MAC_RQMC_Q_PER_REG                      4 //insomnia: old name is MAC_RQC2R_Q_PER_REG
...
#define MAC_RQEC_RXQ0EN_POS                     0
#define MAC_RQEC_RXQ0EN_LEN                     2
...
#define MAC_VR_BXVER_POS                        0
#define MAC_VR_BXVER_LEN                        8
...
#define MAC_MTL_REG(pdata, n, reg)                    \
    ((pdata)->mac_regs + MTL_Q_BASE + ((n) * MTL_Q_INC) + (reg))

#define MAC_DMA_REG(channel, reg)    ((channel)->dma_regs + (reg))

#endif /* __BX_MAC_REG_H__ */